...
//    @Published var wordCount: Int = 75
    ...
    let rawSentenceArray : [String] = ["I just wanted to take another look at you.",
    ...
    let sentenceSource : [String] = ["A star is born",
                                                "Moulin Rouge",
                                                ...
                                                "Adonis",
                                                "Juan, Moonlight"]
    let wordSentence:[[String]] = [["I", "just", "wanted", "to", "take", "another", "look",                                              "at", "you"],
                                            ["The", "greatest", "thing", "you'll", "ever", "learn", "is", "just", "to", "love", "and", "be", "loved", "in", "return"],
                                             ["It's", "only", "after", "we", "have", "lost", "everything", "that", "we", "are", "free", "to", "do", "anything"],
                                             ["It", "is", "not", "our", "abilities", "that", "show", "what", "we", "truly", "are", ",", "it", "is", "our", "choices"],
                                              ["The", "past", "can", "hurt", ",", "but", "you", "can", "either", "run", "from", "it", ",", "or", "learn", "from", "it"],
                                              ["If", "we", "didn't", "do", "what", "we", "loved", ",",  "we", "wouldn't", "exist"],
                                             ["At", "some", "point", "you", "have", "got", "to", "decide", "for", "yourself", "who", "you", "gonna", "be", ".", "Can't", "let", "nobody", "make", "that",]]
